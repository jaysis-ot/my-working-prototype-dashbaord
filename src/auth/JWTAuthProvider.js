...
// ---------------------------------------------------------------------------+
//  Context – provide a sane default so that accessing properties before the
//  provider is mounted will not crash the app.  Methods throw to signal misuse
//  while keeping the object shape intact.
// ---------------------------------------------------------------------------+
const defaultAuthContext = {
  ...
  login: async (_credentials) => {
    throw new Error('AuthProvider is not initialised yet');
  },
  logout: () => {},
