...
import { 
  ...
  Trash2, Save, Plus, RefreshCw, Menu, MoreVertical, Settings
} from 'lucide-react';
...
const RequirementsDashboard = () => {
  ...
  // Keyboard shortcuts - Updated for diagnostics and settings
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      // Cmd/Ctrl + 1-9 for quick view switching
      if ((e.metaKey || e.ctrlKey) && e.key >= '1' && e.key <= '9') {
        e.preventDefault();
        const views = [
          'overview', 'company-profile', 'capabilities', 'requirements', 
          'threat-intelligence', 'mitre-navigator', 'risk-management', 'pcd', 
          'maturity', 'justification', 'analytics', 'diagnostics', 'settings'
        ];
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          <div className="space-y-1">
            {[
              ...
              { id: 'mitre-navigator', name: 'MITRE ATT&CK Navigator', icon: Target }, // NEW VIEW
          ...
          <main className="flex-1 p-4 lg:p-6 overflow-y-auto">
            ...
            {state.ui.viewMode === 'overview' && (
              <div className="space-y-6">
                ...
                {/* Widget Grid - Enhanced with Active Risks */}
                ...
                {/* Quick Actions Section - Enhanced with MITRE Navigator */}
                <div className="bg-white rounded-xl shadow-md p-6">
