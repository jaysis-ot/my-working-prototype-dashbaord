...
const EvidenceLifecycleTimeline = ({
  ...
  useEffect(() => {
    ...
    // ------------------------------------------------------------------
    // Root-cause fix:
    // Clear *all* previous SVG children before redrawing.
    // The previous implementation only removed elements
    // with class `.axis`, leaving threshold lines, labels,
    // current-time indicators, etc. Each re-render stacked
    // more elements, eventually breaking the layout.
    // ------------------------------------------------------------------
