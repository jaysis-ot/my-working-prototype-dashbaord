            ...
            <button
              ...
              className={`w-full flex items-center px-3 py-2 rounded-lg transition-colors ${
                state.ui.viewMode === item.id
                  ...
                  : 'text-white text-gray-300 hover:bg-blue-600 hover:text-white'
              }`}
            >
        ...
        <div className="p-4 border-t border-gray-700">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full flex items-center px-3 py-2 text-sm text-gray-300 hover:bg-blue-600 hover:text-white rounded-lg transition-colors"
            >
      ...
      <div className="px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            {/* Test Toast Button - Remove this in production */}
            <button 
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500">Advanced modal system with backdrop blur • Just now</p>
                    </div>
                  </div>
                </div>
              </div>
