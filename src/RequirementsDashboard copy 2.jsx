...
const RequirementsDashboard = () => {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      // Cmd/Ctrl + 1-7 for quick view switching
      if ((e.metaKey || e.ctrlKey) && e.key >= '1' && e.key <= '7') {
        e.preventDefault();
        const views = ['overview', 'capabilities', 'requirements', 'pcd', 'maturity', 'justification', 'analytics'];
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
        ...
        {/* IMPROVED PORTAL-BASED MODALS - Removed duplicate isOpen props */}
