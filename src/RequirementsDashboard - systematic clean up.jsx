...
const RequirementsDashboard = () => {
  ...
  // FIXED: Improved body scroll prevention for modals
  useEffect(() => {
    const isModalOpen = state.modal.isOpen || state.ui.showUploadModal || state.ui.showPurgeModal || state.ui.showNewCapabilityModal;
  ...
  }, [state.modal.isOpen, state.ui.showUploadModal, state.ui.showPurgeModal, state.ui.showNewCapabilityModal]);
  ...
  const Sidebar = () => (
    <div 
      ...
      style={{ minWidth: state.ui.sidebarExpanded ? '16rem' : '4rem' }}
    >
        ...
        <div className="space-y-2">
          {[
            ...
            >
              ...
              {state.ui.sidebarExpanded && <span className="ml-3 truncate">{item.name}</span>}
            </button>
          ))}
        </div>
      </nav>
  ...
  return (
    <div className="h-screen bg-gray-50 flex overflow-hidden">
        ...
        <main className="flex-1 p-4 lg:p-6 overflow-y-auto">
          ...
          {state.ui.viewMode === 'overview' && (
            <div className="space-y-4 lg:space-y-6">
              ...
              {/* FIXED: Simplified Widget Grid - Removed auto-sizing complexity */}
              <div 
                //className="grid gap-3 lg:gap-4"
                className="grid-cols-auto-fit w-full"
              >
                <StatCard
                ...
                {/* FIXED: Business Value card with white color for better contrast */}
                <StatCard
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-orange-700 text-center">View Analytics</span>
                  </button>
                  <button 
                    onClick={() => {
                      dispatch({ type: 'CLEAR_FILTERS' });
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-900">Dashboard optimized</p>
                      <p className="text-xs text-gray-500">Layout and modals fixed • 1 minute ago</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* FIXED: Simplified Modal Overlays with proper z-index */}
      ...
      {state.ui.showNewCapabilityModal && (
        <div 
          className="fixed inset-0 z-[1000] flex items-center justify-center p-4"
          aria-labelledby="modal-title"
          role="dialog"
